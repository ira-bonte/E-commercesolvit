...
// Mock data
const products = [
  { id: 1, name: 'Transparent Shockproof Case', image: pop1, price: 15, category: 'Iphone 11', rating: 4 },
  { id: 2, name: 'Monica Case', image: pop2, price: 12, category: 'Iphone 12', rating: 5 },
  { id: 3, name: 'Matte Black Case', image: pop3, price: 18, category: 'Samsung S6 Edge', rating: 4 },
];
